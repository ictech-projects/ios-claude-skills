...
> **ICT iOS Team** — This skill cuts release branches following ICT's release process. All output must adhere exactly to the pattern defined in `${CLAUDE_SKILL_DIR}/references/branch-and-version.md`. Do not deviate.
